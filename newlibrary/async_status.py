...
def main(**params):
    ...
    module = AnsibleModule(params=params,argument_spec=dict(
    ...
    if mode == 'cleanup':
        os.unlink(log_path)
        return module.exit_json(ansible_job_id=jid, erased=log_path)
    ...
    try:
        ...
        if data == '':
            ...
            return module.exit_json(results_file=log_path, ansible_job_id=jid, started=1)
        else:
