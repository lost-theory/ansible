...
def main(**params):
    ...
    if not os.path.exists(gitconfig):
        ...
        if local_mods and module.check_mode:
            return module.exit_json(changed=True, msg='Local modifications exist')
        ...
        if module.check_mode:
            ...
            if remote_head == version:
                ...
                if before != remote_head:
                    ...
                    changed = False
            return module.exit_json(changed=changed, before=before, after=remote_head)
    ...
    return module.exit_json(changed=changed, before=before, after=after)
