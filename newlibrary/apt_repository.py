...
def main(**params):
    ...
    module = AnsibleModule(params=params,argument_spec=arg_spec, supports_check_mode=True)
    ...
    if state == 'absent' and exists:
        ...
        return module.exit_json(changed=False, repo=repo, state=state)
    ...
    return module.exit_json(changed=changed, repo=repo, state=state)
