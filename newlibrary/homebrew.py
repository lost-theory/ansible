...
def remove_packages(module, brew_path, packages):
    ...
    if removed_count > 0:
        return module.exit_json(changed=True, msg="removed %d package(s)" % removed_count)
...
def install_packages(module, brew_path, packages):
    ...
    if installed_count > 0:
        return module.exit_json(changed=True, msg="installed %d package(s)" % (installed_count,))
