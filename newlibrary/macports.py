...
def remove_packages(module, port_path, packages):
    ...
    if remove_c > 0:
        ...
        return module.exit_json(changed=True, msg="removed %s package(s)" % remove_c)

    return module.exit_json(changed=False, msg="package(s) already absent")
...
def install_packages(module, port_path, packages):
    ...
    if install_c > 0:
        return module.exit_json(changed=True, msg="installed %s package(s)" % (install_c))

    return module.exit_json(changed=False, msg="package(s) already present")
...
def activate_packages(module, port_path, packages):
    ...
    if activate_c > 0:
        return module.exit_json(changed=True, msg="activated %s package(s)" % (activate_c))

    return module.exit_json(changed=False, msg="package(s) already active")
...
def deactivate_packages(module, port_path, packages):
    ...
    if deactivated_c > 0:
        return module.exit_json(changed=True, msg="deactivated %s package(s)" % (deactivated_c))

    return module.exit_json(changed=False, msg="package(s) already inactive")
